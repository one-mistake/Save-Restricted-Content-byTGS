...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("**🚀 Hacking Craze__**", url="https://t.me/HackingCraze24_7d"),("**🖋️ Groww Study__**", url="https://t.me/HackingCraze24_7d")]]), reply_to_message_id=message.id)
